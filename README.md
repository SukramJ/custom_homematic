# Homematic(IP) local
![GitHub Downloads (all assets, latest release)](https://img.shields.io/github/downloads/SukramJ/custom_homematic/latest/total)
![GitHub Downloads (all assets, latest release)](https://img.shields.io/github/downloads-pre/SukramJ/custom_homematic/latest/total)
